                    ...
                    <div className='self-center mb-6'>
                        ...
                        <div className='flex items-center justify-between'>
                            <div>
                                ...
                                <p className='text-[0.95rem] text-primaryColorGray'>Hoàng Dũng</p>
                            </div>
                            <div className='cursor-pointer gap-2 text-white flex'>
                                <IoIosLink title='Sao chép liên kết bài hát' className='w-[20px] h-[20px] opacity-0 group-hover:opacity-100 transition-transform duration-200 hover:scale-105' />
                                <GoPlusCircle className='w-[20px] h-[20px] transition-transform duration-200 hover:scale-105' />
                            </div>
                        </div>
                    </div>
                    <div className={`relative self-center rounded-md ${currentSong ? 'mb-60' : 'mb-40'} `}>
                        <Image
                        ...
                        />
                        <p className='absolute top-3 left-4 font-semibold z-10 text-[0.95rem]'>Giới thiệu về nghệ sĩ</p>
