...
function Banner() {
  ...
  return (
    <div
      className={`${showSidebarRight ? 'w-[55vw]' : 'w-[75vw] h-[80vh]'} text-primaryColorPink my-4 px-6 py-4 rounded-3xl bg-cover bg-center flex gap-[114px] flex-col relative overflow-hidden`}
    >
