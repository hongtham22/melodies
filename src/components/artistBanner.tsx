...
const ArtistBanner = () => {
    ...
    return (
        <div
            className="w-[75vw] h-[80vh] my-8 px-6 py-4 rounded-3xl bg-cover bg-center flex gap-[114px] flex-col relative overflow-hidden"
        >
            ...
            <div className="z-10 absolute left-[30%] top-[65%]">
