...
const Sidebar = () => {
    ...
    return (
        <div className='fixed top-0 left-0 w-1/5 border-r-2 border-primaryColorPink pt-6 pl-10 pr-7 drop-shadow-lg' style={{ boxShadow: '5px 0 10px rgba(238, 16, 176, 0.2)' }}>
